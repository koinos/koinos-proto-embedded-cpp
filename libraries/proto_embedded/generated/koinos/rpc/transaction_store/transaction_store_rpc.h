...
uint32_t transactions_transaction_header_chain_id_LENGTH, 
uint32_t transactions_transaction_header_nonce_LENGTH, 
uint32_t transactions_transaction_header_operation_merkle_root_LENGTH, 
uint32_t transactions_transaction_header_payer_LENGTH, 
uint32_t transactions_transaction_header_payee_LENGTH, 
...
uint32_t transactions_transaction_signatures_REP_LENGTH, 
uint32_t transactions_transaction_signatures_LENGTH, 
...
class get_transactions_by_id_response final: public ::EmbeddedProto::MessageInterface
{
  public:
    ...
    inline const transaction_store::transaction_item<transactions_transaction_id_LENGTH, transactions_transaction_header_chain_id_LENGTH, transactions_transaction_header_nonce_LENGTH, transactions_transaction_header_operation_merkle_root_LENGTH, transactions_transaction_header_payer_LENGTH, transactions_transaction_header_payee_LENGTH, transactions_transaction_operations_REP_LENGTH, transactions_transaction_operations_upload_contract_contract_id_LENGTH, transactions_transaction_operations_upload_contract_bytecode_LENGTH, transactions_transaction_operations_upload_contract_abi_LENGTH, transactions_transaction_operations_call_contract_contract_id_LENGTH, transactions_transaction_operations_call_contract_args_LENGTH, transactions_transaction_operations_set_system_call_target_system_call_bundle_contract_id_LENGTH, transactions_transaction_operations_set_system_contract_contract_id_LENGTH, transactions_transaction_signatures_REP_LENGTH, transactions_transaction_signatures_LENGTH, transactions_containing_blocks_REP_LENGTH, transactions_containing_blocks_LENGTH>& transactions(uint32_t index) const { return transactions_[index]; }
...
uint32_t get_transactions_by_id_transactions_transaction_header_chain_id_LENGTH, 
uint32_t get_transactions_by_id_transactions_transaction_header_nonce_LENGTH, 
uint32_t get_transactions_by_id_transactions_transaction_header_operation_merkle_root_LENGTH, 
uint32_t get_transactions_by_id_transactions_transaction_header_payer_LENGTH, 
uint32_t get_transactions_by_id_transactions_transaction_header_payee_LENGTH, 
...
uint32_t get_transactions_by_id_transactions_transaction_signatures_REP_LENGTH, 
uint32_t get_transactions_by_id_transactions_transaction_signatures_LENGTH, 
...
class transaction_store_response final: public ::EmbeddedProto::MessageInterface
{
  public:
    ...
    inline void clear_get_transactions_by_id()
    {
      ...
      {
        which_response_ = FieldNumber::NOT_SET;
        response_.get_transactions_by_id_.~get_transactions_by_id_response<get_transactions_by_id_transactions_REP_LENGTH, get_transactions_by_id_transactions_transaction_id_LENGTH, get_transactions_by_id_transactions_transaction_header_chain_id_LENGTH, get_transactions_by_id_transactions_transaction_header_nonce_LENGTH, get_transactions_by_id_transactions_transaction_header_operation_merkle_root_LENGTH, get_transactions_by_id_transactions_transaction_header_payer_LENGTH, get_transactions_by_id_transactions_transaction_header_payee_LENGTH, get_transactions_by_id_transactions_transaction_operations_REP_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_bytecode_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_abi_LENGTH, get_transactions_by_id_transactions_transaction_operations_call_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_call_contract_args_LENGTH, get_transactions_by_id_transactions_transaction_operations_set_system_call_target_system_call_bundle_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_set_system_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_signatures_REP_LENGTH, get_transactions_by_id_transactions_transaction_signatures_LENGTH, get_transactions_by_id_transactions_containing_blocks_REP_LENGTH, get_transactions_by_id_transactions_containing_blocks_LENGTH>();
      }
    }
    inline void set_get_transactions_by_id(const get_transactions_by_id_response<get_transactions_by_id_transactions_REP_LENGTH, get_transactions_by_id_transactions_transaction_id_LENGTH, get_transactions_by_id_transactions_transaction_header_chain_id_LENGTH, get_transactions_by_id_transactions_transaction_header_nonce_LENGTH, get_transactions_by_id_transactions_transaction_header_operation_merkle_root_LENGTH, get_transactions_by_id_transactions_transaction_header_payer_LENGTH, get_transactions_by_id_transactions_transaction_header_payee_LENGTH, get_transactions_by_id_transactions_transaction_operations_REP_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_bytecode_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_abi_LENGTH, get_transactions_by_id_transactions_transaction_operations_call_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_call_contract_args_LENGTH, get_transactions_by_id_transactions_transaction_operations_set_system_call_target_system_call_bundle_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_set_system_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_signatures_REP_LENGTH, get_transactions_by_id_transactions_transaction_signatures_LENGTH, get_transactions_by_id_transactions_containing_blocks_REP_LENGTH, get_transactions_by_id_transactions_containing_blocks_LENGTH>& value)
    {
      if(FieldNumber::GET_TRANSACTIONS_BY_ID != which_response_)
      {
    ...
    inline const get_transactions_by_id_response<get_transactions_by_id_transactions_REP_LENGTH, get_transactions_by_id_transactions_transaction_id_LENGTH, get_transactions_by_id_transactions_transaction_header_chain_id_LENGTH, get_transactions_by_id_transactions_transaction_header_nonce_LENGTH, get_transactions_by_id_transactions_transaction_header_operation_merkle_root_LENGTH, get_transactions_by_id_transactions_transaction_header_payer_LENGTH, get_transactions_by_id_transactions_transaction_header_payee_LENGTH, get_transactions_by_id_transactions_transaction_operations_REP_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_bytecode_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_abi_LENGTH, get_transactions_by_id_transactions_transaction_operations_call_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_call_contract_args_LENGTH, get_transactions_by_id_transactions_transaction_operations_set_system_call_target_system_call_bundle_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_set_system_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_signatures_REP_LENGTH, get_transactions_by_id_transactions_transaction_signatures_LENGTH, get_transactions_by_id_transactions_containing_blocks_REP_LENGTH, get_transactions_by_id_transactions_containing_blocks_LENGTH>& get_get_transactions_by_id() const { return response_.get_transactions_by_id_; }
    inline const get_transactions_by_id_response<get_transactions_by_id_transactions_REP_LENGTH, get_transactions_by_id_transactions_transaction_id_LENGTH, get_transactions_by_id_transactions_transaction_header_chain_id_LENGTH, get_transactions_by_id_transactions_transaction_header_nonce_LENGTH, get_transactions_by_id_transactions_transaction_header_operation_merkle_root_LENGTH, get_transactions_by_id_transactions_transaction_header_payer_LENGTH, get_transactions_by_id_transactions_transaction_header_payee_LENGTH, get_transactions_by_id_transactions_transaction_operations_REP_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_bytecode_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_abi_LENGTH, get_transactions_by_id_transactions_transaction_operations_call_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_call_contract_args_LENGTH, get_transactions_by_id_transactions_transaction_operations_set_system_call_target_system_call_bundle_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_set_system_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_signatures_REP_LENGTH, get_transactions_by_id_transactions_transaction_signatures_LENGTH, get_transactions_by_id_transactions_containing_blocks_REP_LENGTH, get_transactions_by_id_transactions_containing_blocks_LENGTH>& get_transactions_by_id() const { return response_.get_transactions_by_id_; }
    ...
    private:
      ...
      union response
      {
        ...
        get_transactions_by_id_response<get_transactions_by_id_transactions_REP_LENGTH, get_transactions_by_id_transactions_transaction_id_LENGTH, get_transactions_by_id_transactions_transaction_header_chain_id_LENGTH, get_transactions_by_id_transactions_transaction_header_nonce_LENGTH, get_transactions_by_id_transactions_transaction_header_operation_merkle_root_LENGTH, get_transactions_by_id_transactions_transaction_header_payer_LENGTH, get_transactions_by_id_transactions_transaction_header_payee_LENGTH, get_transactions_by_id_transactions_transaction_operations_REP_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_bytecode_LENGTH, get_transactions_by_id_transactions_transaction_operations_upload_contract_abi_LENGTH, get_transactions_by_id_transactions_transaction_operations_call_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_call_contract_args_LENGTH, get_transactions_by_id_transactions_transaction_operations_set_system_call_target_system_call_bundle_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_operations_set_system_contract_contract_id_LENGTH, get_transactions_by_id_transactions_transaction_signatures_REP_LENGTH, get_transactions_by_id_transactions_transaction_signatures_LENGTH, get_transactions_by_id_transactions_containing_blocks_REP_LENGTH, get_transactions_by_id_transactions_containing_blocks_LENGTH> get_transactions_by_id_;
      };
      response response_;
