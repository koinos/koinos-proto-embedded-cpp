...
uint32_t transactions_transaction_passive_LENGTH, 
...
uint32_t get_transactions_by_id_transactions_transaction_passive_LENGTH, 
...
class transaction_store_response final: public ::EmbeddedProto::MessageInterface
{
  public:
    ...
    inline const get_transactions_by_id_response<get_transactions_by_id_transactions_REP_LENGTH, get_transactions_by_id_transactions_transaction_id_LENGTH, get_transactions_by_id_transactions_transaction_active_LENGTH, get_transactions_by_id_transactions_transaction_passive_LENGTH, get_transactions_by_id_transactions_transaction_signature_data_LENGTH, get_transactions_by_id_transactions_containing_blocks_REP_LENGTH, get_transactions_by_id_transactions_containing_blocks_LENGTH>& get_get_transactions_by_id() const { return response_.get_transactions_by_id_; }
